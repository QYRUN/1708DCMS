...
<body background="/resource/images/20190630204026.jpg">
			...
			<div class="col-md-7">
				...
				<form action="/article/search" method="get">
					<div class="input-group mb-3">
						<input type="text" name="key" value="${key }" class="form-control" placeholder="请输入搜索内容"
